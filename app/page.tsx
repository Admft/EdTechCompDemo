  ...
  return (
    <main className="relative overflow-x-clip">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="orb left-[30%] top-[60rem] h-[28rem] w-[28rem] bg-violet-700/15" />
        <div className="orb right-[5%] top-[130rem] h-[26rem] w-[26rem] bg-indigo-600/15" />
        <div
      ...
      {/* ===== Solution ===== */}
      <section id="solution" className="mx-auto max-w-7xl scroll-mt-24 px-5 py-20 sm:px-8">
              ...
              <ul className="mt-6 space-y-3 text-sm text-slate-300">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-500/15 text-[10px] font-bold text-emerald-300">
                      ✓
                    </span>
                    {item}
                  </li>
              ...
              <div className="mt-5 space-y-0">
                {[
                  ...
                  <div key={step.label} className="relative flex gap-4 pb-6 last:pb-0">
                    {i < arr.length - 1 && (
                      <span className="absolute left-[13px] top-8 h-full w-px bg-gradient-to-b from-indigo-400/50 to-transparent" />
                    )}
                    <span className="relative z-10 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-indigo-400/40 bg-indigo-500/15 text-xs font-bold text-indigo-200">
                      {i + 1}
                    </span>
                    <div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {AUDIENCES.map((a) => (
            <div key={a.title} className="glass glass-hover relative overflow-hidden rounded-2xl p-7">
              <div
                aria-hidden
              ...
              <div className="relative">
                ...
                <h3 className="font-display mt-4 text-lg font-semibold text-white">{a.title}</h3>
                <p className="mt-2.5 text-sm leading-relaxed text-slate-400">{a.body}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ===== Discovery ===== */}
      <section id="discover" className="mx-auto max-w-7xl scroll-mt-24 px-5 py-20 sm:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <span className="text-xs font-semibold uppercase tracking-widest text-fuchsia-400">
          ...
          <p className="mt-4 text-slate-400">
            ...
            live <code className="rounded bg-white/10 px-1.5 py-0.5 text-xs text-indigo-300">/api/competitions</code> endpoint.
          </p>
        </div>
        <div className="mt-10">
          <DiscoverySection />
      ...
      {/* ===== Scraper demo ===== */}
      <section id="scraper" className="mx-auto max-w-7xl scroll-mt-24 px-5 py-20 sm:px-8">
        <div className="mx-auto max-w-2xl text-center">
