  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
      ...
      <div className="lg:pt-2">
        {status === "idle" && (
          <div className="glass flex min-h-[320px] flex-col items-center justify-center rounded-3xl border-dashed p-10 text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-500/10 text-3xl">
              🛰️
            </div>
            <p className="font-display mt-5 text-lg font-semibold text-slate-300">
        ...
        {status === "running" && (
          <div className="glass min-h-[320px] rounded-3xl p-8">
            ...
            {result?.extracted && (
              <div className="glass mt-4 rounded-2xl p-5">
                ...
                <dl className="mt-3 space-y-2 text-xs text-slate-400">
                  <div>
                    <dt className="font-medium text-slate-500">Page title</dt>
                    <dd className="mt-0.5 text-slate-300">{result.extracted.pageTitle}</dd>
                  </div>
                  {result.extracted.metaDescription && (
                    <div>
                      <dt className="font-medium text-slate-500">Meta description</dt>
                      <dd className="mt-0.5 line-clamp-2 text-slate-300">
                        {result.extracted.metaDescription}
                      </dd>
                    </div>
                  )}
                  {result.extracted.headings.length > 0 && (
                    <div>
                      <dt className="font-medium text-slate-500">Headings found</dt>
        ...
        {status === "error" && (
          <div className="glass animate-fade-up rounded-3xl border-rose-400/20 p-8">
